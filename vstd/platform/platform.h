...
typedef struct vwindow {
    ...
    struct vwindow_platform_state* platform_state;

    /** @brief Holds renderer-specific data. */
    struct vwindow_renderer_state* renderer_state;
} vwindow;
...
typedef void (*platform_window_closed_callback)(const struct vwindow* window);
typedef void (*platform_window_resized_callback)(const struct vwindow* window);
 ...
 */
VAPI b8 platform_system_startup(u64* memory_requirement, struct platform_state* state, platform_system_config* config);
 ...
 */
VAPI void platform_system_shutdown(struct platform_state* state);
 ...
 */
VAPI b8 platform_window_create(const vwindow_config* config, struct vwindow* window, b8 show_immediately);
 ...
 */
VAPI void platform_window_destroy(struct vwindow* window);
 ...
 * @return b8 True on success; otherwise false.
 */
VAPI b8 platform_window_show(struct vwindow* window);
 ...
 * @return b8 True on success; otherwise false.
 */
VAPI b8 platform_window_hide(struct vwindow* window);
 ...
 */
VAPI const char* platform_window_title_get(const struct vwindow* window);
 ...
 * @return VAPI True on success; otherwise false.
 */
VAPI b8 platform_window_title_set(struct vwindow* window, const char* title);
 ...
 * @return True on success; otherwise false.
 */
VAPI b8 platform_pump_messages(void);
 ...
 */
VAPI void* platform_zero_memory(void* block, u64 size);
 ...
 */
VAPI void* platform_copy_memory(void* dest, const void* source, u64 size);
 ...
 */
VAPI void* platform_set_memory(void* dest, i32 value, u64 size);
 ...
 */
VAPI void platform_console_write(struct platform_state* platform, log_level level, const char* message);
 ...
 */
VAPI f64 platform_get_absolute_time(void);
 ...
 */
VAPI i32 platform_get_processor_count(void);
 ...
 */
VAPI f32 platform_device_pixel_ratio(const struct vwindow* window);
 ...
 */
VAPI void* platform_dynamic_library_load_function(const char* name, dynamic_library* library);
 ...
 */
VAPI void platform_register_watcher_deleted_callback(platform_filewatcher_file_deleted_callback callback);
 ...
 * @param callback A pointer to the handler function.
 */
VAPI void platform_register_watcher_written_callback(platform_filewatcher_file_written_callback callback);
 ...
 * @param callback A pointer to the handler function.
 */
VAPI void platform_register_window_closed_callback(platform_window_closed_callback callback);
 ...
 * @param callback A pointer to the handler function.
 */
VAPI void platform_register_window_resized_callback(platform_window_resized_callback callback);
 ...
 * @return VAPI
 */
VAPI void platform_register_process_key(platform_process_key callback);
 ...
 * @param callback A pointer to the handler function.
 */
VAPI void platform_register_process_mouse_button_callback(platform_process_mouse_button callback);
 ...
 * @param callback A pointer to the handler function.
 */
VAPI void platform_register_process_mouse_move_callback(platform_process_mouse_move callback);
 ...
 * @param callback A pointer to the handler function.
 */
VAPI void platform_register_process_mouse_wheel_callback(platform_process_mouse_wheel callback);
